...
class Game:
    ...
    def makeTreasury(self, id):
        ...
        treasury.form=self.makeForm(id)
    ...
    def makeTreasuryOctaedro(self, id):
        treasury=Treasury(id)
    ...
    def create4Room1TresOcataedroLab(self):
        room1 = self.makeRoomOctaedro(1)
        room2 = self.makeRoomOctaedro(2)
        room3 = self.makeRoomOctaedro(3)
        room4 = self.makeRoomOctaedro(4)
        tres5 = self.makeTreasuryOctaedro(5)
